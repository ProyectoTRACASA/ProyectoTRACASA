...
Partial Public Class A_Abono
    ...
    End Sub
    Partial Private Sub OnSobrantesChanging(value As Double)
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Vales", DbType:="Float NOT NULL")>  _
	Public Property Vales() As Double
		Get
			Return Me._Vales
		End Get
		Set
			If ((Me._Vales = value)  _
						= false) Then
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Sobrantes", DbType:="Float NOT NULL")>  _
	Public Property Sobrantes() As Double
		Get
			Return Me._Sobrantes
		End Get
		Set
			If ((Me._Sobrantes = value)  _
						= false) Then
...
Partial Public Class Ca_Carreras
	...
	Private _Zo_Zona As EntitySet(Of Zo_Zona)
	...
	Public Sub New()
		MyBase.New
		Me._Zo_Zona = New EntitySet(Of Zo_Zona)(AddressOf Me.attach_Zo_Zona, AddressOf Me.detach_Zo_Zona)
		OnCreated
	End Sub
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Ca_Carreras_Zo_Zona", Storage:="_Zo_Zona", ThisKey:="ID", OtherKey:="ID_Carrera")>  _
	Public Property Zo_Zona() As EntitySet(Of Zo_Zona)
		Get
			Return Me._Zo_Zona
		End Get
		Set
			Me._Zo_Zona.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_Zo_Zona(ByVal entity As Zo_Zona)
		Me.SendPropertyChanging
		entity.Ca_Carreras = Me
	End Sub
	
	Private Sub detach_Zo_Zona(ByVal entity As Zo_Zona)
		Me.SendPropertyChanging
...
Partial Public Class Co_Control
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Zo_Zona_Co_Control", Storage:="_Zo_Zona", ThisKey:="ID_Zona", OtherKey:="Zona_ID", IsForeignKey:=true)>  _
...
Partial Public Class Zo_Zona
    ...
    End Sub
    Partial Private Sub OnID_CarreraChanging(value As Integer)
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Zona_ID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_ID_Carrera", DbType:="Int NOT NULL")>  _
	Public Property ID_Carrera() As Integer
		Get
			Return Me._ID_Carrera
		End Get
		Set
			If ((Me._ID_Carrera = value)  _
						= false) Then
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Zo_Zona_Co_Control", Storage:="_Co_Control", ThisKey:="Zona_ID", OtherKey:="ID_Zona")>  _
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Ca_Carreras_Zo_Zona", Storage:="_Ca_Carreras", ThisKey:="ID_Carrera", OtherKey:="ID", IsForeignKey:=true)>  _
		...
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
					...
					previousValue.Zo_Zona.Remove(Me)
				End If
				Me._Ca_Carreras.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.Zo_Zona.Add(Me)
					Me._ID_Carrera = value.ID
				Else
					Me._ID_Carrera = CType(Nothing, Integer)
				End If
